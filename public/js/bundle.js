...
var updateAccountData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, email) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function updateAccountData(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var accountDataForm = document.querySelector("#update-data-form"); // DELEGATION
...
if (accountDataForm) {
  accountDataForm.addEventListener("submit", function (e) {
    ...
    var email = document.getElementById("email").value;
    (0, _account.updateAccountData)(firstName, lastName, email);
  });
}
