...
var showAlert = function showAlert(type, msg) {
  ...
  var markup = "<div class=\"alert alert-".concat(alertType, "\">").concat(msg, "</div>");
...
var displayMap = function displayMap(location) {
  ...
  var popup = new mapboxgl.Popup({
    offset: 30
  }).setLngLat(location).setHTML("<p>".concat(branch, "</p>")).addTo(map);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            endpoint = type === "data" ? "updateMe" : "changePassword";
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:5000/api/v1/auth/".concat(endpoint),
              data: data
            });
...
var stripe = Stripe("pk_test_51I9SWFI34OVmnrKNVEI8d6zi34ozzYfUpLN3zk5RJ8aBFVYLIlzbiY3TXcs3UJD1gLGvsyMIWwG02jgzmJG6x8He00HSH0alT1");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/orders/checkout-session/".concat(orderId));
...
var accountDataForm = document.querySelector("#account-data-form");
var accountPasswordForm = document.querySelector("#account-password-form");
var updateCountryForm = document.querySelector("#update-country-form");
var checkoutBtn = document.querySelector("#checkout-btn"); // DELEGATION
...
if (map) {
  ...
  location = location.split(_templateObject()).map(function (x) {
    return +x;
  });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _account.updateAccount)("password", {
...
if (updateCountryForm) {
  updateCountryForm.addEventListener("submit", /*#__PURE__*/function () {
